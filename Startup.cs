...
using UnitOfWorkSample.Services;
...
namespace UnitOfWorkSample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbContext, PlatformContext>
                (item => item.UseSqlServer(Configuration.GetConnectionString("LocalConnection")));
